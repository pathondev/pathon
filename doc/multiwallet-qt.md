...
In order to support loading of multiple wallets in pat-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pat.cpp.
...
Changes to pat.cpp
----------------------
pat.cpp is the entry point into pat-qt, and as such, will require some minor modifications to provide hooks for
