                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Mined POW"), TransactionFilterProxy::TYPE(TransactionRecord::Generated));
    typeWidget->addItem(tr("Mined POS"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint));
