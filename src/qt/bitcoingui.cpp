                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PAT-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PAT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pat: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PATHON"), this);
    aboutAction->setStatusTip(tr("Show information about PATHON"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PAT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PAT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PAT addresses"));
    ...
    openAction->setStatusTip(tr("Open a PAT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PATHON help message to get a list with possible PAT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PATHON client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PAT network", "", count));
}
...
{
    QString strTitle = tr("PATHON"); // default title
