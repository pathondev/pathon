...
#if defined(NDEBUG)
#error "PAT cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "PAT Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	} else if (nHeight > 5 && nHeight <=6) {
		nSubsidy = 105120 * COIN;
	} else if (nHeight > 10 && nHeight <= 2000) {
		nSubsidy = 0.1 * COIN;
        } else if (nHeight > 2000 && nHeight <= 100000) {
                 nSubsidy = 10 * COIN;
