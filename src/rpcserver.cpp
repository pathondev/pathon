...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PAT features */
        {"pat", "masternode", &masternode, true, true, false},
        {"pat", "masternodelist", &masternodelist, true, true, false},
        {"pat", "mnbudget", &mnbudget, true, true, false},
        {"pat", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"pat", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pat", "mnsync", &mnsync, true, true, false},
        {"pat", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use patd, or the -server option to pat-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> pat-cli " + methodname + " " + args + "\n";
}
