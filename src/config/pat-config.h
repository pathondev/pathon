/* src/config/pat-config.h.  Generated from pat-config.h.in by configure.  */
/* src/config/pat-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://bit.pats"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PATHON"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PATHON 1.0.0"
