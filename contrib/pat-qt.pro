...
RESOURCES += src/qt/pat.qrc src/qt/pat_locale.qrc

TRANSLATIONS += src/qt/locale/pat_bg.ts \
                src/qt/locale/pat_de.ts \
                src/qt/locale/pat_en.ts \
                src/qt/locale/pat_es.ts \
                src/qt/locale/pat_fi.ts \
                src/qt/locale/pat_fr.ts \
                src/qt/locale/pat_it.ts \
                src/qt/locale/pat_ja.ts \
                src/qt/locale/pat_pl.ts \
                src/qt/locale/pat_pt.ts \
                src/qt/locale/pat_ru.ts \
                src/qt/locale/pat_sk.ts \
                src/qt/locale/pat_sv.ts \
                src/qt/locale/pat_vi.ts \
                src/qt/locale/pat_zh_CN.ts \
                src/qt/locale/pat_zh_TW.ts
