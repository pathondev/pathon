...
pkgdatadir = $(datadir)/pat
pkgincludedir = $(includedir)/pat
pkglibdir = $(libdir)/pat
pkglibexecdir = $(libexecdir)/pat
...
CONFIG_HEADER = $(top_builddir)/src/config/pat-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/pat-config.h.in \
...
ACLOCAL = ${SHELL} /home/jinine79/pathon/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/jinine79/pathon/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/jinine79/pathon/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/jinine79/pathon/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/jinine79/pathon/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = pat
PACKAGE_BUGREPORT = http://bit.pats
PACKAGE_NAME = PATHON
PACKAGE_STRING = PATHON 1.0.0
PACKAGE_TARNAME = pat
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/jinine79/pathon
abs_srcdir = /home/jinine79/pathon
abs_top_builddir = /home/jinine79/pathon
abs_top_srcdir = /home/jinine79/pathon
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/jinine79/pathon/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/patd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/pat-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/pat-cli$(EXEEXT)
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_pat_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_pat_coverage.info test_pat.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/GDC-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/pat-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/pat-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/pat-config.h
$(top_srcdir)/src/config/pat-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/pat-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/GDC-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/GDC-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/GDC-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_pat.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_pat -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_pat_filtered.info: test_pat.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_pat_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_pat_coverage.info: baseline_filtered_combined.info test_pat_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_pat_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_pat_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_pat_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_pat.coverage/.dirstamp:  test_pat_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_pat.coverage/.dirstamp total.coverage/.dirstamp

# GDC: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_pat.coverage/ total.coverage/ $(OSX_APP)
